...
The main files are 
  - WHILE.flex, which is the lexical grammar (in JFlex)
  - WHILE.parser, which is the context-free grammar (in Beaver)
  - WHILE.ast, which defines the Abstract Syntax Trees for the language.
