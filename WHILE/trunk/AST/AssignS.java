...
/**
 * @ast node
 * @declaredat /home/anonymous/WHILE/trunk/WHILE.ast:23
 * @production AssignS : {@link S} ::= <span class="component">LabelAST:{@link Label}</span> <span class="component">&lt;Var:String&gt;</span> <span class="component">{@link Expr}</span>;

 */
public class AssignS extends S implements Cloneable, Block {
   ...
   */
  public AssignS(Label p0, String p1, Expr p2) {
    setChild(p0, 0);
    setVar(p1);
    setChild(p2, 1);
  }
   ...
   */
  public AssignS(Label p0, beaver.Symbol p1, Expr p2) {
    setChild(p0, 0);
    setVar(p1);
    setChild(p2, 1);
  }
   ...
   */
  public AssignS clone() throws CloneNotSupportedException {
    AssignS node = (AssignS) super.clone();
    return node;
  }
  /**
   * @apilevel internal
   ...
   */
  public AssignS treeCopyNoTransform() {
    AssignS tree = (AssignS) copy();
    if (children != null) {
  ...
  protected boolean is$Equal(ASTNode node) {
    return super.is$Equal(node) && (tokenString_Var == ((AssignS)node).tokenString_Var);    
  }
  /**
  ...
  public Block Define_itsBlock(ASTNode caller, ASTNode child) {
    if (caller == getLabelASTNoTransform()) {
      // @declaredat /home/anonymous/WHILE/trunk/CFG.jrag:115
      return this;
    }
    else {
