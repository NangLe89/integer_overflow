...
/**
 * @ast node
 * @declaredat /home/anonymous/WHILE/trunk/WHILE.ast:17
 * @production RelExpr : {@link Expr} ::= <span class="component">Left:{@link Expr}</span> <span class="component">Op:{@link Op_r}</span> <span class="component">Right:{@link Expr}</span>;

 */
public class RelExpr extends Expr implements Cloneable {
  /**
   ...
   */
  public RelExpr(Expr p0, Op_r p1, Expr p2) {
    setChild(p0, 0);
    setChild(p1, 1);
    setChild(p2, 2);
  }
   ...
   */
  public RelExpr clone() throws CloneNotSupportedException {
    RelExpr node = (RelExpr) super.clone();
    return node;
  }
  /**
   * @apilevel internal
   ...
   */
  public RelExpr treeCopyNoTransform() {
    RelExpr tree = (RelExpr) copy();
    if (children != null) {
   ...
   * @apilevel low-level
   */
  public Op_r getOpNoTransform() {
    return (Op_r) getChildNoTransform(1);
  }
  /**
   ...
   * @declaredat /home/anonymous/WHILE/trunk/TypeChecking.jrag:62
   */
   ...
   * @attribute coll
   * @aspect TypeInference
   * @declaredat /home/anonymous/WHILE/trunk/TypeChecking.jrag:69
   */
