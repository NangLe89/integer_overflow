...
/**
 * @ast node
 * @declaredat /home/anonymous/WHILE/trunk/WHILETaint.ast:2
 * @production SanitizeS : {@link S} ::= <span class="component">LabelAST:{@link Label}</span> <span class="component">&lt;Var:String&gt;</span>;

 */
public class SanitizeS extends S implements Cloneable, Block {
   ...
   */
  public SanitizeS(Label p0, String p1) {
    setChild(p0, 0);
    setVar(p1);
  }
  /**
   ...
   */
  public SanitizeS(Label p0, beaver.Symbol p1) {
    setChild(p0, 0);
    setVar(p1);
  }
  /**
   ...
   */
  public SanitizeS clone() throws CloneNotSupportedException {
    SanitizeS node = (SanitizeS) super.clone();
    return node;
  }
  /**
   * @apilevel internal
   ...
   */
  public SanitizeS copy() {
    try {
      SanitizeS node = (SanitizeS) clone();
      node.parent = null;
      if (children != null) {
   ...
   */
  public SanitizeS treeCopyNoTransform() {
    SanitizeS tree = (SanitizeS) copy();
    if (children != null) {
  ...
  protected boolean is$Equal(ASTNode node) {
    return super.is$Equal(node) && (tokenString_Var == ((SanitizeS)node).tokenString_Var);    
  }
  /**
  ...
  public Set<Expr> genAE() {
    ...
    Set<Expr> genAE_value = SetRepUtility.emptySet();
  ...
  public Set<String> FV() {
    ...
    Set<String> FV_value = SetRepUtility.singleton(getVar());
  ...
  public Set<String> genLV() {
    ...
    Set<String> genLV_value = SetRepUtility.emptySet();
  ...
  public Set<Map.Entry> genRD() {
    ...
    Set<Map.Entry> genRD_value = SetRepUtility.singleton(
  ...
  public String unparse() {
    ...
    String unparse_value = "[" + "sanitize " + getVar() + "]^" + getLabelAST().unparse();
  ...
  public Set<Expr> genVB() {
    ...
    Set<Expr> genVB_value = SetRepUtility.emptySet();
  ...
  public Block Define_itsBlock(ASTNode caller, ASTNode child) {
    if (caller == getLabelASTNoTransform()) {
      // @declaredat /home/anonymous/WHILE/trunk/CFGTaint.jrag:35
      return this;
    }
    else {
