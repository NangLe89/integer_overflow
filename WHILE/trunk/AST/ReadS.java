...
/**
 * @ast node
 * @declaredat /home/anonymous/WHILE/trunk/WHILETaint.ast:1
 * @production ReadS : {@link S} ::= <span class="component">LabelAST:{@link Label}</span> <span class="component">&lt;Var:String&gt;</span>;

 */
public class ReadS extends S implements Cloneable, Block {
   ...
   */
  public ReadS(Label p0, String p1) {
    setChild(p0, 0);
    setVar(p1);
  }
  /**
   ...
   */
  public ReadS(Label p0, beaver.Symbol p1) {
    setChild(p0, 0);
    setVar(p1);
  }
  /**
   ...
   */
  public ReadS clone() throws CloneNotSupportedException {
    ReadS node = (ReadS) super.clone();
    return node;
  }
  /**
   * @apilevel internal
   ...
   */
  public ReadS treeCopyNoTransform() {
    ReadS tree = (ReadS) copy();
    if (children != null) {
  ...
  protected boolean is$Equal(ASTNode node) {
    return super.is$Equal(node) && (tokenString_Var == ((ReadS)node).tokenString_Var);    
  }
  /**
  ...
  public String unparse() {
    ...
    String unparse_value = "[" + "read " + getVar() + "]^" + getLabelAST().unparse();
  ...
  public Block Define_itsBlock(ASTNode caller, ASTNode child) {
    if (caller == getLabelASTNoTransform()) {
      // @declaredat /home/anonymous/WHILE/trunk/CFGTaint.jrag:34
      return this;
    }
    else {
