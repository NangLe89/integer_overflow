...
/**
 * @ast node
 * @declaredat /home/anonymous/WHILE/trunk/WHILE.ast:11
...
public class NumLitExpr extends Expr implements Cloneable {
   ...
   */
  public NumLitExpr(beaver.Symbol p0) {
    setContents(p0);
  }
  /**
   * @apilevel low-level
   ...
   */
  public NumLitExpr treeCopyNoTransform() {
  ...
  protected boolean is$Equal(ASTNode node) {
    return super.is$Equal(node) && (tokenString_Contents == ((NumLitExpr)node).tokenString_Contents);    
  }
  /**
