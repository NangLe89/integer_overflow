...
/**
 * @ast node
 * @declaredat /home/anonymous/WHILE/trunk/WHILE.ast:5
...
public class Op_r extends Op implements Cloneable {
   ...
   */
  public Op_r treeCopyNoTransform() {
    Op_r tree = (Op_r) copy();
    if (children != null) {
  ...
  protected boolean is$Equal(ASTNode node) {
    return super.is$Equal(node) && (tokenString_Contents == ((Op_r)node).tokenString_Contents);    
  }
  /**
