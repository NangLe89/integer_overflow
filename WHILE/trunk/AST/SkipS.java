...
/**
 * @ast node
 * @declaredat /home/anonymous/WHILE/trunk/WHILE.ast:24
 * @production SkipS : {@link S} ::= <span class="component">LabelAST:{@link Label}</span>;

 */
public class SkipS extends S implements Cloneable, Block {
   ...
   */
  public SkipS clone() throws CloneNotSupportedException {
    SkipS node = (SkipS) super.clone();
    return node;
  }
  /**
   * @apilevel internal
   ...
   */
  public SkipS treeCopyNoTransform() {
    SkipS tree = (SkipS) copy();
    if (children != null) {
  ...
  public Set<String> FV() {
    ...
    Set<String> FV_value = SetRepUtility.emptySet();
  ...
  public String unparse() {
    ...
    String unparse_value = "[skip]^" + getLabelAST().unparse();
  ...
  public Block Define_itsBlock(ASTNode caller, ASTNode child) {
    if (caller == getLabelASTNoTransform()) {
      // @declaredat /home/anonymous/WHILE/trunk/CFG.jrag:116
      return this;
    }
    else {
