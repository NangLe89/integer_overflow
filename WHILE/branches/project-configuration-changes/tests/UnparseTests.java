 ...
 */
public class UnparseTests extends WHILETestCase {
	...
	public void testUnparse() {
		for (int i = 1; i <= NUMTESTS; i++) {
			compareUnparse("testsrc/syntax" + i + ".wh", 
					"testsrc/syntax" + i + ".wh-prettyprint");
		}
	}

	public void testPrettyPrint() {
		for (int i = 1; i <= NUMTESTS; i++) {
			comparePrettyPrint("testsrc/syntax" + i + ".wh", 
					"testsrc/syntax" + i + ".wh-prettyprint");
		}
	}
