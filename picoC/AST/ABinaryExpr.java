...
/**
 * @ast node
 * @declaredat C:\\Users\\Nang LE\\Documents\\GitHub\\integer_overflow\\picoC\\grammar\\picoC.ast:26
 * @production ABinaryExpr : {@link Expr} ::= <span class="component">Left:{@link Expr}</span> <span class="component">Op:{@link Op_arth}</span> <span class="component">Right:{@link Expr}</span>;
...
public class ABinaryExpr extends Expr implements Cloneable {
   ...
   */
  public ABinaryExpr(Expr p0, Op_arth p1, Expr p2) {
    setChild(p0, 0);
    setChild(p1, 1);
    setChild(p2, 2);
  }
   ...
   * @apilevel high-level
   */
  public void setOp(Op_arth node) {
    setChild(node, 1);
  }
  /**
  ...
  public Op_arth getOp() {
    return (Op_arth) getChild(1);
  }
  /**
   * Retrieves the Op child.
   * <p><em>This method does not invoke AST transformations.</em></p>
   ...
   * @apilevel low-level
   */
  public Op_arth getOpNoTransform() {
    return (Op_arth) getChildNoTransform(1);
  }
  /**
