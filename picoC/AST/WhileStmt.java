...
/**
 * @ast node
 * @declaredat C:\\Users\\Nang LE\\Documents\\GitHub\\integer_overflow\\picoC\\grammar\\picoC.ast:13
 * @production WhileStmt : {@link Stmt} ::= <span class="component">{@link LabeledExpr}</span> <span class="component">{@link Stmt}</span>;
...
public class WhileStmt extends Stmt implements Cloneable {
   ...
   */
  public WhileStmt(LabeledExpr p0, Stmt p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /** @apilevel low-level 
