...
/**
 * @ast node
 * @declaredat C:\\Users\\Nang LE\\Documents\\GitHub\\integer_overflow\\picoC\\grammar\\picoC.ast:19
 * @production Op_arth : {@link Op};

 */
public class Op_arth extends Op implements Cloneable {
  /**
   ...
   */
  public Op_arth(String p0) {
    setContents(p0);
  }
  /**
   * @declaredat ASTNode:15
   */
  public Op_arth(beaver.Symbol p0) {
    setContents(p0);
  }
  /** @apilevel low-level 
   ...
   */
  public Op_arth clone() throws CloneNotSupportedException {
    Op_arth node = (Op_arth) super.clone();
    return node;
  }
  /** @apilevel internal 
   ...
   */
  public Op_arth treeCopyNoTransform() {
    Op_arth tree = (Op_arth) copy();
    if (children != null) {
  ...
  protected boolean is$Equal(ASTNode node) {
    return super.is$Equal(node) && (tokenString_Contents == ((Op_arth) node).tokenString_Contents);    
  }
  /**
