...
public class VarDeclStmt extends Stmt implements Cloneable {
   ...
   */
  public VarDeclStmt(Access p0, String p1) {
    setChild(p0, 0);
    setID(p1);
  }
  /**
   ...
   */
  public VarDeclStmt(Access p0, beaver.Symbol p1) {
    setChild(p0, 0);
    setID(p1);
  }
  /** @apilevel low-level 
  ...
  protected boolean is$Equal(ASTNode node) {
    return super.is$Equal(node) && (tokenString_ID == ((VarDeclStmt) node).tokenString_ID);    
  }
  /**
