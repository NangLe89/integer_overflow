...
/**
 * @ast node
 * @declaredat C:\\Users\\Nang LE\\Documents\\GitHub\\anyname\\integer_overflow\\grammar\\picoC.ast:10
 * @production BreakStmt : {@link Stmt} ::= <span class="component">&lt;Identifier:String&gt;</span>;
...
public class BreakStmt extends Stmt implements Cloneable {
   ...
   */
  public BreakStmt(int p0, String p1) {
    setl(p0);
    setIdentifier(p1);
  }
  /**
   ...
   */
  public BreakStmt(int p0, beaver.Symbol p1) {
    setl(p0);
    setIdentifier(p1);
  }
  /** @apilevel low-level 
  ...
  protected boolean is$Equal(ASTNode node) {
    return super.is$Equal(node) && (tokenint_l == ((BreakStmt) node).tokenint_l) && (tokenString_Identifier == ((BreakStmt) node).tokenString_Identifier);    
  }
  /**
  ...
  public Set<Integer> finals() {
    Set<Integer> finals_value = new HashSet();
    return finals_value;
  }
  /**
   * @attribute syn
