...
/**
 * @ast node
 * @declaredat C:\\Users\\Nang LE\\Documents\\GitHub\\anyname\\integer_overflow\\grammar\\picoC.ast:117
 * @production PrimitiveTypeAccess : {@link TypeAccess};
...
public class PrimitiveTypeAccess extends TypeAccess implements Cloneable {
  ...
  protected boolean is$Equal(ASTNode node) {
    return super.is$Equal(node) && (tokenString_ID == ((PrimitiveTypeAccess) node).tokenString_ID);    
  }
  /**
