...
public class ASTNode<T extends ASTNode> extends beaver.Symbol implements Cloneable {
  ...
  public Set<Expr> Define_AexpStar(ASTNode _callerNode, ASTNode _childNode) {
    ...
    while (parent != null && !parent.canDefine_AexpStar(self, _callerNode)) {
      _callerNode = self;
      self = parent;
      parent = self.getParent();
    }
    return parent.Define_AexpStar(self, _callerNode);
  }

  /**
   * @declaredat C:\\Users\\Nang LE\\Documents\\GitHub\\anyname\\integer_overflow\\AExp.jrag:98
   * @apilevel internal
   * @return {@code true} if this node has an equation for the inherited attribute AexpStar
   */
